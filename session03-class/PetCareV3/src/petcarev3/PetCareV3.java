...
public class PetCareV3 {
    ...
    public static void main(String[] args) {
        ...
        // vi diệu tiếp theo gọi thầm tên em
        System.out.println("gọi thầm tên em: " + chiHu); // dân pro hay dùng thay vì dùng toString
        // chỉ áp dụng cho toString, các hàm khác phải dùng . để gọi 
