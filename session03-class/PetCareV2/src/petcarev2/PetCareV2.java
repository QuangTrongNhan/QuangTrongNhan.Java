...
public class PetCareV2 {
    ...
    public static void main(String[] args) {
        ...
        // this này là this của class n~ obj từ khuôn petcarev2
        //k phải là dog 
        //this ứng với mỗi khuôn khac nhau, xổ ra những gì khác nhau 
        //ứng với khuôn đó 
        //cái tôi của mỗi loài/nhóm/khuôn 
        //chấm là hỏi bên trong obj có gì 
